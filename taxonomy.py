...
TAXONOMY = {
    "tasks": [
        ...
        Concept("stacking", "Stacking", "堆叠", "manipulation",
                ["stack", "stacking", "堆叠", "码放", "cube stacking", "block stacking"]),
        Concept("cleaning", "Cleaning / Wiping", "擦拭清洁", "manipulation",
                ["wipe", "clean", "sweep", "擦", "擦桌子", "清洁", "打扫", "wipe the table"]),
        Concept("pressing", "Pressing / Button", "按压", "manipulation",
                ["press", "push button", "按", "按压", "按键", "按钮"]),
        Concept("sorting", "Sorting", "分拣", "manipulation",
                ["sort", "classify", "分拣", "分类", "归类"]),
        Concept("cutting", "Cutting", "切割", "manipulation",
                ["cut", "slice", "切", "切割", "cutting"]),
        Concept("hanging", "Hanging", "悬挂", "manipulation",
                ["hang", "hook", "挂", "悬挂", "挂起"]),
        Concept("closing", "Closing", "关闭", "manipulation",
                ["close", "shut", "关", "关闭", "关门", "关抽屉", "close drawer"]),
        Concept("screwing", "Screwing / Threading", "拧转穿绳", "manipulation",
                ["screw", "unscrew", "thread", "拧", "拧螺丝", "穿", "穿绳", "screwdriver"]),
        Concept("handover", "Handover", "递交", "manipulation",
                ["hand over", "handover", "give", "pass", "递", "递交", "传递"]),
        Concept("cooking", "Cooking / Kitchen", "烹饪", "manipulation",
                ["cook", "cooking", "kitchen task", "烹饪", "做饭", "炒", "coffee", "咖啡"]),
        Concept("long_horizon", "Long-horizon", "长程任务", "",
                ["long horizon", "multi-step", "multi step", "长程", "多步", "长时序"]),
        Concept("navigation", "Navigation", "导航", "",
                ["navigate", "nav", "move to", "导航", "移动", "mobile"]),
    ],
    "scenes": [
